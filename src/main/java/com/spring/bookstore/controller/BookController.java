...
public class BookController {
    ...
    public String search(@RequestParam("searchInput")String searchInput, Model
            model) {
        ...
        if (searchInput.isEmpty()) {
            ...
            resultList =
                    bookRepository.findByNameContainingOrAuthorContaining(searchInput, searchInput);
        }
    ...
    @RequestMapping(value = "/newBook", method = POST, produces =
    ...
    private void setCategoryDropDownlist(Model model) {
        List<CategoryEntity> cateList = (List<CategoryEntity>)
