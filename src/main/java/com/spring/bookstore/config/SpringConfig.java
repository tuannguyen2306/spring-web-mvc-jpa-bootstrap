...
@Configuration
@EnableJpaRepositories(basePackages = "com.spring.bookstore.repository")
...
public class SpringConfig {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/spring-jpa-bootstrap-demo");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource
        ...
        entityManager.setPackagesToScan("com.spring.bookstore.entity");
